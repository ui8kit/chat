...
export default defineConfig({
  plugins: [
    react(),
    // Minimal API route for ChatKit session creation in dev/preview
    (function chatkitCreateSessionPlugin() {
      ...
      return {
        name: 'chatkit-create-session',
        configureServer(server: any) {
          server.middlewares.use('/api/create-session', (req: any, res: any, next: any) => {
